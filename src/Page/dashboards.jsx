...
import { TrendingUp, Users, DollarSign, Calendar, PieChart, LineChart, XCircle, Download, RefreshCw, MoreHorizontal } from 'lucide-react';
  ...
  return (
    <div className="dashboard-container">
      ...
      <style jsx>{`
        ...
        .dashboard-container .component-eyebrow { font-family: 'Orbitron', sans-serif; }
        ...
        .welcome-text p {
          margin: 0; font-size: 0.9rem; color: rgba(255,255,255,0.82);
        ...
        .header-content h2 {
          ...
          color: var(--primary-color); letter-spacing: 0.04em;
        }
        .header-content p {
          margin: 0; color: var(--text-muted); font-size: 0.875rem;
          font-family: 'Inter', sans-serif;
        }
        .header-filters {
        ...
        .component-eyebrow {
          ...
          text-transform: uppercase; opacity: 0.65; margin-bottom: 3px;
        }
        .component-title h3 {
        ...
        .error-container h3 { margin: 12px 0 6px; font-size: 0.85rem; letter-spacing: 0.05em; }
        .error-container p { font-family: 'Inter', sans-serif; font-size: 0.875rem; }
        ...
        .error-container button:hover { opacity: 0.88; transform: translateY(-1px); }

        .loading-fallback {
          display: flex; align-items: center; justify-content: center; gap: 10px;
          padding: 60px; color: var(--text-muted); font-size: 0.875rem;
        }
        .loader {
        ...
        @media (max-width: 1024px) {
          .dashboard-container { margin-left: 80px; width: calc(100% - 80px); }
        }
        @media (max-width: 768px) {
          .dashboard-container { padding: 16px; margin-left: 0; width: 100%; }
          ...
          .component-header { flex-wrap: wrap; gap: 12px; }
        }
      `}</style>
    </div>
  );
